...
def load_model_tokenizer():
    peft_model_id = "GymBoy/lora-flan-t5-large-chat"
...
message("Hi I am GymBoy Chatbot. How can I help you?", is_user=False)

placeholder = st.empty()
input_ = st.text_input("instruction")

if st.button("Generate"):
    with placeholder.container():
        message(input_, is_user=True)
    input_ = "instruction: " + input_ + ". output: "
